                    ...
                    <form id="login-form" novalidate>
                        ...
                        <div className="form-group">
                            <div className="senha-row">
                                <label className="form-label" for="input-senha" style="margin-bottom:0;">Senha</label>
{/* Criar uma página ou modal para isso */} <a href="#" className="forgot-link" id="link-esqueceu-senha">Esqueceu sua senha?</a>
                        ...
                        <button type="button" className="btn btn-secondary" id="btn-criar-conta">Criar uma conta</button>
